...
<script>
	import freeMediaList from "@/commonPackage/free-ui/free-media-list.vue"
	import freePopup from "@/commonPackage/free-ui/free-popup.vue"
	import freeAvater from "@/commonPackage/free-ui/free-avater.vue"
	...
	export default {
		...
		methods: {
			flushData(){
				...
				console.log(getApp().globalData.userList)
				this.flushCnt++;
			},
			// long({
			// 	x,
