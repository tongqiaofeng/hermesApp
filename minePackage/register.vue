			...
			<uni-forms ref="registerForm" :modelValue="registerData" :rules="registerRules">
				<uni-forms-item name="nick">
					<view class="register-every">
						<text class="every-font" :style="{color: plurSelect == 1 ? '#000' : '#c3c3c3'}">昵称</text>
						<input class="every-input" placeholder="请输入昵称" placeholder-style="color: #dadada;" type="text"
							v-model="registerData.nick" @focus="nickFocus" />
						<view class="every-line" :style="{backgroundColor: plurSelect == 1 ? '#85dbd0' : '#ebebeb'}">
						</view>
					</view>
				</uni-forms-item>
				<uni-forms-item name="phoneNumber">
					<view class="register-every">
						<text class="every-font" :style="{color: plurSelect == 2 ? '#000' : '#c3c3c3'}">手机号/邮箱</text>
						<input class="every-input" placeholder="请输入手机号/邮箱" placeholder-style="color: #dadada;"
							type="text" v-model="registerData.phoneNumber" @focus="phoneFocus" />
						<view class="every-line" :style="{backgroundColor: plurSelect == 2 ? '#85dbd0' : '#ebebeb'}">
						</view>
					</view>
				</uni-forms-item>
				<uni-forms-item name="code">
					<view class="register-every">
						...
						<view style="display: flex;align-items: center;justify-content: space-between;">
							...
							<button type="text" :plain="true" size="mini" style="border: none;padding: 0;" @click="getCode" class="phone-num" :disabled="disable"
								:class="{ codeGeting: isGeting }"><text
									style="margin: 0 10px;color: #c3c3c3;">|</text>{{time}}</button>
						</view>
						<view class="every-line" :style="{backgroundColor: plurSelect == 3 ? '#85dbd0' : '#ebebeb'}">
						</view>
					</view>
				</uni-forms-item>
