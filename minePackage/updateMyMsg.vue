	...
	<view class="update-my-msg-container">
		<view class="update-main">
			<view class="update-list">
				...
				<view style="display: flex;justify-content: flex-end;flex: 1;align-items: center;" @click="uploadClick">
		...
		<view class="update-button">
			<image src="../static/imgs/common/update.png" mode="aspectFill" @click="updateMsgSure"></image>
		</view>
	</view>
</template>
