<template>
	<view class="details-container">
				...
				<checkbox-group @change="isShowChange">
					<label>
						<checkbox :value="isShow" v-model="isShow" color="#85dbd0"
							style="transform: scale(0.6); border-radius: 50%" /><text style="margin-left: -6rpx">是否显示</text>
					</label>
				</checkbox-group>
			</view>
		</view>
		...
		<view class="product-price" v-if="role == 'admin'">
			<text style="font-size: 22rpx">{{ bagDetails.indiCurrency }}<text style="font-size: 30rpx">{{
		...
		<view class="product-parameter" v-if="tabSelType == 1">
			...
			<view class="parameter-every" v-if="bagDetails.cost">
				...
				<view>
					...
					<text v-if="role == 'admin'" style="color: #ff8b62; padding-left: 20rpx">{{ "CNY " +
						formatNumberRgx(bagDetails.cnCost) }}</text>
				</view>
			</view>
			<view class="parameter-every" v-if="bagDetails.pricePeer && bagDetails.pricePeer != 0">
				...
				<view>
					<text style="color: #73d1c6">{{
						bagDetails.peerCurrency + " " + formatNumberRgx(bagDetails.pricePeer)
					}}</text>
					<text v-if="role == 'admin'" style="color: #ff8b62; padding-left: 20rpx">{{ "CNY " +
						formatNumberRgx(bagDetails.cnPricePeer) }}</text>
				</view>
			</view>
		...
		<view class="product-parameter" v-if="tabSelType == 2">
			...
			<view class="parameter-every" v-if="bagDetails.saleTotalHkPrice">
				...
				<view>
					...
					<text v-if="role == 'admin'" style="color: #ff8b62; padding-left: 20rpx">{{ "CNY " +
						formatNumberRgx(bagDetails.saleTotalCnPrice) }}</text>
				</view>
			</view>
