	...
	<view class="main">
        ...
        " hover-class="none">
			...
			<view class="classify-big-container">
				<navigator :url="'../comm/search?type=' + tabItems[1].name" hover-class="none"
					class="classify-big-every">
					<view class="title">
						奢品包袋
					</view>
					<view class="desc">
					...
					<view class="img">
						<image style="width: 209rpx;height: 158rpx;" src="../static/imgs/index/new/img02.png"
							mode="aspectFill"></image>
					</view>
				</navigator>
				<navigator :url="'../comm/search?type=' + tabItems[2].name" hover-class="none"
					class="classify-big-every">
					<view class="title">
						时尚潮物
					</view>
					...
					<view class="img">
						<image style="width: 220rpx;height: 151rpx;" src="../static/imgs/index/new/img03.png"
							mode="aspectFill"></image>
					</view>
				</navigator>
				<navigator :url="'../comm/search?type=' + tabItems[0].name" hover-class="none"
					class="classify-big-every">
					<view class="title">
						潮流腕表
					</view>
					...
					<view class="img">
						<image style="width: 129rpx;height: 154rpx;" src="../static/imgs/index/new/img01.png"
							mode="aspectFill"></image>
					</view>
				</navigator>
			</view>
				...
				<view class="item" style="position: relative">
					...
					<view class="price" v-if="item.sellPrice != 0">
						<text> {{ item.currency }} <text
								style="font-size: 30rpx">{{ " " + formatNumberRgx(item.sellPrice) }}</text> </text>
					</view>
		...
		<view v-if="tabItems[tabIndex].id == 'H'" class="list">
			<view v-for="(item, index3) in tabItems[tabIndex].list" :key="item.uuid">
				<view class="item">
					...
					<view class="price" v-if="item.sellPrice != 0">
						<text> HKD <text style="font-size: 30rpx">{{ " " + formatNumberRgx(item.priceIndi) }}</text>
						</text>
					</view>
					<view class="price" style="font-size: 24rpx" v-else>价格请咨询客服</view>
				</view>
